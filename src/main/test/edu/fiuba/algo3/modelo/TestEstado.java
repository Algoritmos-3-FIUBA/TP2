...
public class TestEstado {
    ...
    @Test
    public void jugadorCon35PuntosRespondeCorrectamente(){

        EstadoCorrecto estado = new EstadoCorrecto();

        int puntosFinales = estado.sumarPuntos(35);

        assertEquals(36,puntosFinales);
    }
    @Test
    public void jugadorCon10PuntosRespondeIncorrectamente(){
    ...
    @Test
    public void jugadorCon12PuntosRespondeIncorrectamente(){

        EstadoIncorrecto estado = new EstadoIncorrecto();

        int puntosFinales = estado.sumarPuntos(12);
